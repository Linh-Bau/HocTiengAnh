...
using HocTiengAnh.ViewModels.Windows;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<OnlineDictionaryService>();
                services.AddSingleton<WordSpeakerService>();
                ...
                services.AddSingleton<AppLoggingPage>();
                services.AddSingleton<AppLoggingViewModel>();
